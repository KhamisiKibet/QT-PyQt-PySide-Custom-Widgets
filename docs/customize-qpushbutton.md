...
6. Create "style.json" file which will be used for styling the buttons. Copy and paste the following code inside "style.json" file.
...
7. Optional step: If you want to see how the user interface looks like in QT Designer and maybe modify it, create a file, name it "interface.ui", copy and paste the following code inside "interface.ui" file.
